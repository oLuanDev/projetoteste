import { User, Job, Candidate, Talent, Resume, CandidateStatus, CandidateInterview } from './types';
...
export const INITIAL_JOBS: Job[] = [
  {
    ...
    benefits: [
      ...
      'Refeição no local',
      'Bônus de R$100,00 por assiduidade',
      'Plano TotalPass',
    ...
    sources: [
        ...
        { name: 'Google Forms', url: 'https://docs.google.com/forms/d/e/1FAIpQLScNZx80oU5wkuL8UOEAB8jkU462-bBa2KC2sCXE5VsMtKxMtQ/viewform?fbzx=-8542822492865397387' }
    ],
    status: 'active',
  },
  {
...
const approvedSg01Candidates: Candidate[] = [
    {
        ...
        jobId: 'sg-01', fitScore: 9.8, status: 'applied', applicationDate: new Date().toISOString(), source: 'LinkedIn', isArchived: false, gender: 'female',
        resume: {
    ...
    },
    {
        ...
        jobId: 'sg-01', fitScore: 9.5, status: 'applied', applicationDate: new Date().toISOString(), source: 'Indicação', isArchived: false, gender: 'male',
        resume: {
