...
const Dashboard: React.FC<DashboardProps> = ({ jobs, candidates }) => {
  ...
  const sources = useMemo(() => [...new Set(candidates.map(c => c.source).filter(Boolean))] as string[], [candidates]);
  ...
  return (
    <div>
      <div className="mb-8">
       ...
       {/* Filters */}
       <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 p-4 bg-light-surface dark:bg-surface rounded-xl border border-light-border dark:border-border">
          <div>
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-light-surface dark:bg-surface rounded-xl shadow-lg p-6 border border-light-border dark:border-border">
             ...
             <div className="bg-light-surface dark:bg-surface rounded-xl shadow-lg p-6 border border-light-border dark:border-border flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-light-border dark:border-border">
