        ...
        setMessages([
            {
                id: Date.now(),
                sender: 'ai',
                text: `Olá, ${user.username}! Sou a assistente de IA do Lacoste Burger. Como posso ajudar você hoje a otimizar seu processo de recrutamento?`,
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-10rem)] max-w-4xl mx-auto bg-light-surface dark:bg-surface rounded-xl border border-light-border dark:border-border shadow-xl">
            <div className="p-4 border-b border-light-border dark:border-border">
                <h1 className="text-xl font-bold text-light-text-primary dark:text-text-primary">Assistência com IA</h1>
            </div>
